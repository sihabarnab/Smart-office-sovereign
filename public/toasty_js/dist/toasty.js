...
;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "./public/toasty_js/dist/sounds/info/1.mp3",
            // path to sound for successfull message:
            success: './public/toasty_js/dist/sounds/success/1.mp3',
            // path to sound for warn message:
            warning: "./public/toasty_js/dist/sounds/warning/1.mp3",
            // path to sound for error message:
            error: "./public/toasty_js/dist/sounds/error/1.mp3",
        },
