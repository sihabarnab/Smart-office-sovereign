...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('elc_task_assign_update', $m_task_assign->task_id) }}" method="post">
                                @csrf
    ...
    @else
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('elc_task_assign_store') }}" method="post">
                                @csrf
        ...
        @include('electrical.task_assign_list')
    @endif
