@extends('layouts.electrical_app')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('elc_update_helper', $edit_helper->id) }}" method="post">
                                @csrf
    ...
    @else
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('elc_add_helper', $mt_task_assign->task_id) }}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-12 col-sm-12">
                                        ...
                                        @endphp
                                        @if ($check)
                                            <a href="{{ route('elc_task_assign_final') }}"
        ...
        @include('electrical.helper_list')
    @endif
@endsection
