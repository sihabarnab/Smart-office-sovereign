            ...
            <div class="card">
                <div class="card-body">
                  <div align="left" class=""><h5>{{ "Edit" }}</h5></div>
                    <form action="{{ route('mt_TeamInfoUpdate',$edit_teams->team_id) }}" method="post">
                        @csrf
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                <select name="cbo_leader_id" id="cbo_leader_id" class="form-control">
                                    ...
                                    @foreach ($leaders as $leader)
                                        <option value="{{ $leader->employee_id }}" {{$leader->employee_id == $edit_teams->team_leader_id ?"selected":"" }}>
            ...
            <div class="card">
                <div class="card-body">
                  <div align="left" class=""><h5>{{ "Add" }}</h5></div>
                    <form action="{{ route('mt_team_info_store') }}" method="post">
                        @csrf
...
@include('maintenance.team_info_list')
