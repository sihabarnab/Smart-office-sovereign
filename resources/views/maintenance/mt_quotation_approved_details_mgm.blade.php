            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($m_quotation_approved_details as $key => $row)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ numberFormat($row->qty, 2) }}</td>
                                        <td class="text-center">{{ numberFormat($row->rate, 2) }}</td>
                                ...
                                @if ($m_quotation_master->repair_price)
                                    ...
                                    <tr>
                                        <td class="text-center">{{ $i++ }}</td>
                                        <td class="text-center">{{ $m_quotation_master->repair_descrption }}</td>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-4 col-sm-1"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7">
                                        <input type="text" class="form-control  text-right" id="txt_discount"
                                            name="txt_discount"
                                            value=" {{ numberFormat($m_quotation_master->discount, 2) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7">
                                        <input type="text" class="form-control text-right" id="txt_vat"
                                            name="txt_vat" value="{{ numberFormat($m_quotation_master->vat, 2) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7">
                                        <input type="text" class="form-control  text-right" id="txt_ait"
                                            name="txt_ait" value="{{ numberFormat($m_quotation_master->ait, 2) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7">
                                        <input type="text" class="form-control text-right" id="txt_other"
                                            name="txt_other" value="{{ numberFormat($m_quotation_master->other, 2) }}"
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6 col-sm-4 text-right">
                                Grand Total
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-8">
                                <input type="text" class="form-control text-right" id="txt_other" name="txt_other"
                                    value="{{ numberFormat($m_quotation_master->quotation_total + $repair_price, 2) }}"
                                    readonly>
                            </div>
                        </div>

                        <form action="{{ route('mt_quotation_reject', $m_quotation_master->quotation_id) }}"
                            method="post">
                            @csrf
                            <div class="row mt-2">
                        ...
                        <div class="col-lg-2 col-md-12 col-sm-12 mt-2">
                            <a href="{{ route('mt_quotation_accept', $m_quotation_master->quotation_id) }}"
