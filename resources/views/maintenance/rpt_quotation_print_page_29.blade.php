            ...
            <div class="col-12">
                <table class="table table-borderless table-sm m-0">
                    ...
                    <tbody class="table-borderless">
                        ...
                        {{-- 22 gape, increse product per gape  minus  --}}

                        @php
                            $tr_count = 35 - $countRaw;
                            $next_page = (int) ($tr_count / 2);
                        @endphp
                        @for ($x = 0; $x <= $tr_count; $x++)
                            @if ($next_page == $x)
                                <tr>
                                    <td colspan="6" class="text-center" style=" opacity: 0.5;">Page Number (1/2)</td>
                                    {{-- <td colspan="5">&nbsp;</td> --}}
                                </tr>
                            @else
                                <tr>
                        ...
                        @for ($x = 0; $x <= $page; $x++)
                            @if ($page == $x)
                                <tr>
                                    <td colspan="6" class="text-center" style=" opacity: 0.5;">Page Number (2/2)
                                    </td>
