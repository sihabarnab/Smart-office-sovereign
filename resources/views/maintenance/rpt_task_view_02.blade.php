                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-3">{{ $ci_complain->complaint_description?$ci_complain->complaint_description:''}} | {{ $txt_lift_name }}</div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-10 d-flex justify-content-center">
                                        ...
                                        <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                            onclick="showimg('{{ asset("$work_start->image_1") }}')">
                                            <img src="{{ asset("$work_start->image_1") }}" alt="" width="150px"
                                                height="150px">&nbsp;
                                        </a>
                                        <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                            onclick="showimg('{{ asset("$work_start->image_2") }}')">
                                            <img src="{{ asset("$work_start->image_2") }}" alt="" width="150px"
                                                height="150px">&nbsp;
                                        </a>
                                        <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                            onclick="showimg('{{ asset("$work_start->image_3") }}')">
                                            <img src="{{ asset("$work_start->image_3") }}" alt="" width="150px"
                                                height="150px">&nbsp;
                                        </a>
                                        <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                            onclick="showimg('{{ asset("$work_start->image_4") }}')">
                                            <img src="{{ asset("$work_start->image_4") }}" alt="" width="150px"
                                                height="150px">&nbsp;
                                        </a>
                                        <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                            onclick="showimg('{{ asset("$work_start->image_5") }}')">
                                            <img src="{{ asset("$work_start->image_5") }}" alt="" width="150px"
                                                height="150px">&nbsp;
                                        </a>
                                    </div>
                                    <div class="col-1"></div>
                            ...
                            @if (isset($task_complite))
                                @if ($task_complite->complete_date)
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-10 d-flex justify-content-center">
                                            <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                                onclick="showimg('{{ asset("$task_complite->image_1") }}')">
                                                <img src="{{ asset("$task_complite->image_1") }}" alt=""
                                                    width="150px" height="150px">&nbsp;
                                            </a>
                                            <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                                onclick="showimg('{{ asset("$task_complite->image_2") }}')">
                                                <img src="{{ asset("$task_complite->image_2") }}" alt=""
                                                    width="150px" height="150px">&nbsp;
                                            </a>
                                            <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                                onclick="showimg('{{ asset("$task_complite->image_3") }}')">
                                                <img src="{{ asset("$task_complite->image_3") }}" alt=""
                                                    width="150px" height="150px">&nbsp;
                                            </a>
                                            <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                                onclick="showimg('{{ asset("$task_complite->image_4") }}')">
                                                <img src="{{ asset("$task_complite->image_4") }}" alt=""
                                                    width="150px" height="150px">&nbsp;
                                            </a>
                                            <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                                onclick="showimg('{{ asset("$task_complite->image_5") }}')">
                                                <img src="{{ asset("$task_complite->image_5") }}" alt=""
                                                    width="150px" height="150px">&nbsp;
                                            </a>
                                        </div>
                                        <div class="col-1"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-flex justify-content-center">
                                            <a class="btn" data-toggle="modal" data-target=".bd-example-modal-lg2"
                                                onclick="showimg('{{ asset("$task_complite->feedback") }}')">
                                                <img src="{{ asset("$task_complite->feedback") }}" alt=""
                                                    width="150px" height="150px">&nbsp;
                                            </a>
                                        </div>
                                        <div class="col-3"></div>
