            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('maintenance_due_store_money') }}" method="post">
                            @csrf
                            {{-- // --}}
                            ...
                            <div class="row mb-2">
                                <div class="col-8">
                                    <textarea class="form-control" cols="10" rows="3" placeholder="Previous Due" readonly>{{ $m_bill_master->due_description }}</textarea>
                                </div>
                                <div class="col-4">
                                    <label for="txt_due">Previous Due</label>
                                    <input type="text" class="form-control" id="txt_due" name="txt_due"
                                        value="{{ $m_bill_master->previous_due }}" readonly>
                                </div>
