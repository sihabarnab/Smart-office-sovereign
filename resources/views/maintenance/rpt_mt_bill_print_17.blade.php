                    ...
                    <tbody class="table-borderless">
                        ...
                        <tr>
                            <td colspan="3" class="text-left">
                                <strong>Invoice Date :</strong> {{ $m_bill_master->entry_date }} <br>
                                <strong>Quotation Date :</strong> {{ $m_bill_master->quotation_date }} <br>
                            </td>
                            <td colspan="3" class="text-right">
                                <strong>Invoice No :</strong> {{ $m_bill_master->maintenance_bill_master_no }} <br>
                                <strong>Quotation No :</strong> {{ $m_bill_master->quotation_master_id }} <br>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6"></td>
                        ...
                        <tr>
                            <td colspan="6">
                                <strong>Subject:- </strong> &nbsp; {{ $m_bill_master->subject }} <br> <br>
                        ...
                        <tr>
                            <th width='10%' class="text-center font-weight-bold" style="border: 1px solid #DEE2E6;">
                                SL NO</th>
                            <th width='40%' class="text-center font-weight-bold" style="border: 1px solid #DEE2E6;">
                                DESCRIPTION</th>
                            <th width='10%' class="text-center font-weight-bold" style="border: 1px solid #DEE2E6;">
                                QTY</th>
                            <th width='10%' class="text-center font-weight-bold" style="border: 1px solid #DEE2E6;">
                        ...
                        @foreach ($m_bill_details as $key => $row)
                            ...
                            <tr>
                                <td width='10%' class="text-center" style="border: 1px solid #DEE2E6;">
                                    {{ $i++ }}</td>
                                <td width='40%' style="border: 1px solid #DEE2E6;">{{ $row->product_name }}</td>
                                <td width='10%' class="text-center" style="border: 1px solid #DEE2E6;">
                                    {{ $qty }} </td>
                                <td width='10%' class="text-center" style="border: 1px solid #DEE2E6;">
                                    {{ $row->unit_name }} </td>
                        ...
                        <tr>
                            <td colspan="5" class="text-right font-weight-bold" style="border: 1px solid #DEE2E6;">
                                SUB-TOTAL:</td>
                        ...
                        <tr>
                            <td colspan="3"></td>
                            <td colspan="2" class="text-right font-weight-bold" style="border: 1px solid #DEE2E6;">
                                DISCOINT
                            ...
                            <td colspan="1" class="text-right font-weight-bold" style="border: 1px solid #DEE2E6;">
                                {{ $discount }}
                            </td>
                        </tr>
                        <tr>
