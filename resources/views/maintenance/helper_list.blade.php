                                    ...
                                    <td>
                                        @php
                                            ...
                                            $helper_name = DB::table('pro_employee_info')
                                                ...
                                                ->first();
                                        @endphp
                                        {{ $team->team_name }} | {{ $leader->employee_name }}
                                    </td>
                                    <td>{{ $helper_name->employee_name }}</td>
                                    <td><a href="{{route('mt_edit_helper',$helper->id)}}">Edit</a></td>
                                    <td><a href="{{route('mt_remove_helper',$helper->id)}}">Remove</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
