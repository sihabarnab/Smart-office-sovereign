                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4"> {{ $txt_lift_name }}.</div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            @php
                                ...
                                if (isset($task_complite)) {
                                    $quotaion_comment =
                                        $task_complite->quotation_status == null ? '' : "$task_complite->quotation_status";
                                } else {
                                    $quotaion_comment = '';
                                }
                            @endphp
                            ...
                            @if (isset($task_complite))
                                @if ($task_complite->complete_date)
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                         <textarea name="" class="form-control" id="" cols="10" rows="4" placeholder="Description">{{ $task_complite->description }}</textarea>
                                        </div>
                                    </div>
                                @else
                                    <div class="row mb-1">
