              ...
              <div class="col-4">
                <select name="sele_weekly_holiday1" id="sele_weekly_holiday1" class="from-control custom-select">
                    @php
                      ...
                      if($m_att_policy->weekly_holiday1==0){
                        $txt_holiday1='N/A';  
                      } else if ($m_att_policy->weekly_holiday1==1){
                        $txt_holiday1='Saturday';  
                      } else if ($m_att_policy->weekly_holiday1==2){
                        $txt_holiday1='Sunday';  
                      } else if ($m_att_policy->weekly_holiday1==3){
                        $txt_holiday1='Monday';  
                      } else if ($m_att_policy->weekly_holiday1==4){
                        $txt_holiday1='Tuesday';  
                      } else if ($m_att_policy->weekly_holiday1==5){
                        $txt_holiday1='Wednesday';  
                      } else if ($m_att_policy->weekly_holiday1==6){
                        $txt_holiday1='Thursday';  
                      } else if ($m_att_policy->weekly_holiday1==7){
                        $txt_holiday1='Friday';  
                      }

                    @endphp

                    <option value="{{ $m_att_policy->weekly_holiday1 }}">{{ $txt_holiday1 }}</option>
              ...
              <div class="col-4">
                <select name="sele_weekly_holiday2" id="sele_weekly_holiday2" class="from-control custom-select">
                    @php
                      ...
                      if($m_att_policy->weekly_holiday2==0){
                        $txt_holiday2='N/A';  
                      } else if ($m_att_policy->weekly_holiday2==1){
                        $txt_holiday2='Saturday';  
                      } else if ($m_att_policy->weekly_holiday2==2){
                        $txt_holiday2='Sunday';  
                      } else if ($m_att_policy->weekly_holiday2==3){
                        $txt_holiday2='Monday';  
                      } else if ($m_att_policy->weekly_holiday2==4){
                        $txt_holiday2='Tuesday';  
                      } else if ($m_att_policy->weekly_holiday2==5){
                        $txt_holiday2='Wednesday';  
                      } else if ($m_att_policy->weekly_holiday2==6){
                        $txt_holiday2='Thursday';  
                      } else if ($m_att_policy->weekly_holiday2==7){
                        $txt_holiday2='Friday';  
                      }

                    @endphp

                    <option value="{{ $m_att_policy->weekly_holiday2 }}">{{ $txt_holiday2 }}</option>
