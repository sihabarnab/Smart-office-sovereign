        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('mech_lift_info_update',$m_lifts->lift_id) }}" method="post">
                        @csrf
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('mech_lift_info_store') }}" method="post">
                        @csrf
...
@include('mechanical.lift_info_list')
@endif
