...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form name="" method="post"
                                action="{{ route('mech_project_info_update', $m_project->project_id) }}">
                                @csrf
                                <div class="row mb-2">
                                    <div class="col-3">
                                ...
                                <div class="row mb-2">
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="txt_contact_persone" name="txt_contact_persone"
                                            placeholder="First Contact Person" value="{{ $m_project->contact_persone_01 }}">
                                        @error('txt_contact_persone')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="txt_contact_number" name="txt_contact_number"
                                            placeholder="Contact Number" value="{{ $m_project->contact_number_01 }}">
                                ...
                                <div class="row mb-2">
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="txt_contact_persone2" name="txt_contact_persone2"
                                            placeholder="Second Contact Person" value="{{ $m_project->contact_persone_02 }}">
                                        @error('txt_contact_persone2')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="txt_contact_number2" name="txt_contact_number2"
                                            placeholder="Contact Number" value="{{ $m_project->contact_number_02 }}">
    ...
    @else
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('mech_ProjectInfoStore') }}" method="post">
                                @csrf
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-3">
                                        <input type="number" class="form-control" id="txt_warranty" name="txt_warranty"
                                            placeholder="Warranty" value="{{ old('txt_warranty') }}">
                                        @error('txt_warranty')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
        ...
        @include('mechanical.project_info_list')
    @endif
@section('script')
    <script>
