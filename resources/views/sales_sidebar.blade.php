    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          $data_pro_sub_mnu_for_users=DB::table('pro_sub_mnu_for_users')->Where('emp_id',$txt_emp_id)->where('module_id','6')->where('valid','1')->groupBy('main_mnu_id')->get();
          ...
          <li class="nav-item">
            ...
            @php
            $data_pro_sub_mnu_for_users_02=DB::table('pro_sub_mnu_for_users')->where('main_mnu_id',$m_main_mnu_id)->Where('emp_id',$txt_emp_id)->where('module_id','6')->where('valid','1')->get();
