                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update_helper', $edit_helper->id) }}" method="post">
                                @csrf
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('add_helper', $mt_task_assign->task_id) }}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-12 col-sm-12">
                                        ...
                                        @endphp
                                        @if ($check)
                                            <a href="{{ route('task_assign_final') }}"
