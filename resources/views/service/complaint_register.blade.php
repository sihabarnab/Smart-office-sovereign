                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('complaint_register_update',$m_complaint_register1->complaint_register_id) }}" method="post" >
                                @csrf
                                <div class="row mb-2">
                                    <div class="col-4">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('complaint_register_store') }}" method="post">
                                @csrf
