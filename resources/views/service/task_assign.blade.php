...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('task_assign_update', $m_task_assign->task_id) }}" method="post">
                                @csrf
    ...
    @else
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('task_assign_store') }}" method="post">
                                @csrf
                                        ...
                                        <select name="cbo_team_id" id="cbo_team_id" class="form-control">
                                            ...
                                            @foreach ($m_teams as $row_team)
                                                <option value="{{ $row_team->team_id }}">
                                                    {{ $row_team->team_name }} | {{ $row_team->employee_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('cbo_team_id')
        ...
        @include('service.task_assign_list')
    @endif
