    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('rpt_search_task') }}" method="GET">
                            @csrf
                            <div class="row mb-2">
                                <div class="col-5">
                            ...
                            <table id="data1" class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    @foreach ($search_task as $key => $mt_task_assign)
                                        ...
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $mt_task_assign->task_id }} <br> {{ $mt_task_assign->entry_date}} <br> {{ $mt_task_assign->entry_time}}</td>
                                            ...
                                            <td>
                                                <a target="__blanck"
                                                    href="{{ route('rpt_task_view', $mt_task_assign->task_id) }}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
