...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="dropdown">
                        <button class="btn dropdown-toggle nav-link" type="button" data-toggle="dropdown"
                            aria-expanded="false">
                            <i class="far fa-bell" id="msCount" style="font-size: 1.60em;">{{ $dataCount }}</i>
                        </button>
    ...
    <script>
        ...
        function notify(massage, setTime) {
            var myToast = new Toasty();
            setTimeout(() => {
                myToast.success(massage);
            }, setTime);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "allDelete") {
                            ...
                            // massage count
                            const bellIcon = document.getElementById("msCount");
                            bellIcon.innerHTML = "0";
                        } else {
                            $('#' + x).remove();
                            var myToast = new Toasty();
                            ...
                            // massage count
                            const bellIcon = document.getElementById("msCount");
                            const countmassge = bellIcon.innerHTML;
                            if (countmassge == 0) {
                                bellIcon.innerHTML = 0;
                            } else {
                                bellIcon.innerHTML = countmassge - 1;
                            }
                        }
