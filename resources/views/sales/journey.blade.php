        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <form action="{{ route('sales_end_journey_store') }}" method="post">
                        @csrf
                        ...
                        <div class="card border border-success">
                            ...
                            <div class="card-body">
                                <input type="hidden" name="txt_task_id" value="{{ $journey->task_id }}">
                                <input type="hidden" name="taxt_journey_id" value="{{ $journey->journey_id }}">
                                <div class="row mb-2">
